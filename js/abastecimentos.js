  ...
  try {
    ...
    if (
      ...
      App.toast(
        ...
        ') deve ser maior que o Ãºltimo abastecimento registrado (' +
        App.fmtNum(ultimoKm) +
        ' km).',
        'erro'
      );
    ...
    App.toast(
      'NÃ£o foi possÃ­vel validar o KM informado.',
      'erro'
    );
